...
class Drogue extends StatefulWidget {
  Drogue({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _DrogueState createState() => _DrogueState();
}

class _DrogueState extends State<Drogue> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("drogues par voi intraveinseuse ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 30,
