...
import 'tatouage.dart';
import 'package:blood_app/menu_pages/home.dart';

class Fievre extends StatefulWidget {
  Fievre({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _FievreState createState() => _FievreState();
}
                ...
                child: ListView(children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text(
                            " \n Avez vous ressenti une fiévre ou été traité pour    ",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 30, fontWeight: FontWeight.bold)),
                        Text("une infection dans les 2 dernieres semaines ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 30,
