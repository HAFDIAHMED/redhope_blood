...
class Tatouage extends StatefulWidget {
  Tatouage({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _TatouageState createState() => _TatouageState();
}

class _TatouageState extends State<Tatouage> {
  @override
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("un piercing ou un taouage ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 30,
                        ...
                        Center(
                          child: RaisedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => Soin()),
                              );
                            },
                          ),
                        ),
