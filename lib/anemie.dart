...
class Anemie extends StatefulWidget {
  Anemie({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _AnemieState createState() => _AnemieState();
}

class _AnemieState extends State<Anemie> {
  @override
              ...
              child: Center(
                child: ListView(children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        Text(" \n Avez vous été déjà été  traité pour   ",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                fontSize: 30, fontWeight: FontWeight.bold)),
                        Text("anémie ou manque de fer ?",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontSize: 30,
